// <copyright file="WebAuthenticatorResult.cs" company="Drastic Actions">
// Copyright (c) Drastic Actions. All rights reserved.
// </copyright>

using Mauimgur.Core.Utilities;
...
namespace Mauimgur.Core.Models {
    ...
    /// </remarks>
    public class CustomWebAuthenticatorResult {
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomWebAuthenticatorResult"/> class.
        /// </summary>
        public CustomWebAuthenticatorResult() {
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="CustomWebAuthenticatorResult"/> class by parsing a URI's query string parameters.
        /// </summary>
        /// <remarks>
        ...
        public CustomWebAuthenticatorResult(Uri uri) {
            CallbackUri = uri;
            var properties = WebUtils.ParseQueryString(uri.ToString());
        ...
        public CustomWebAuthenticatorResult(IDictionary<string, string> properties) {
            foreach (var kvp in properties)
                Properties[kvp.Key] = kvp.Value;
        }
